...
static const std::filesystem::path RESOURCE_DIR_PATH = std::filesystem::path("resources");
static const std::filesystem::path GAME_CONFIG_PATH = RESOURCE_DIR_PATH / std::filesystem::path("game.config");
static const std::filesystem::path RENDER_CONFIG_PATH = RESOURCE_DIR_PATH / std::filesystem::path("rendering.config");
