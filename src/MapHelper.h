...
/* MapHelper.h : Utility header containing convenient data structures for
 * homework #3 */
  ...
  public:
    ...
    Actor(std::string actor_name, char view, glm::ivec2 position, glm::ivec2 initial_velocity, bool blocking,
        ...
        : actor_name(actor_name), view(view), position(position), velocity(initial_velocity), blocking(blocking),
          nearby_dialogue(nearby_dialogue), contact_dialogue(contact_dialogue), visited(false)
    {
    }
...
inline std::vector<Actor> hardcoded_actors = {
    Actor("spartan1",         // Actor name
          ...
          true,               // blocking?
          "Hey, you! (the spartan throws a fake plastic spear at you. "
          "It bounces off but kinda hurts your ego a bit. [health "
          "down])", // nearby_dialogue
          "Gotcha! (the spartan is right next to you, and pokes you "
          "with a fake plastic spear. They're really into it and "
          "having a good time, and we can't be having that. [health "
          "down])" // contact_dialogue
          ),
    Actor("spartan2", 's', glm::ivec2(22, 13), glm::ivec2(0, 0), true,
          "Hey, you! (the spartan throws a fake plastic spear at you. It "
          "bounces off but kinda hurts your ego a bit. [health down])",
          "Gotcha! (the spartan is right next to you, and pokes you with "
          "a fake plastic spear. They're really into it and having a "
          "good time, and we can't be having that. [health down])"),
    ...
    Actor("sparty", 'S', glm::ivec2(12, 22), glm::ivec2(1, 0), false,
          "Oh no... it's Sparty himself! His sinister unflinching eyes "
          "scan the darkness in your direction. You'd better be extra "
          "careful!)",
          "(you bump into sparty and he falls onto you clumsily. It's "
          "all very embarrassing and you can feel the life squeezing "
          "out of you) [game over]"),
    Actor("wolverine1", 'w', glm::ivec2(11, 15), glm::ivec2(0, 0), false,
          "(One of your wolverine classmates is nearby) \"Hey-- be "
          "careful! Some spartans are sneaking around over there. Stay "
          "far away and slip past if you can... It looks like some of "
          "the other students are panicking, which I told them to not "
          "do! And now they're lost in the darkness. Look for their "
          "('f') icon and go see if you can calm them down. Then, get "
          "out of there and go find Professor Yarger!\"",
          "(you're standing on your friend, but they don't seem to "
          "mind. They are a good friend.)"),
    Actor("494 student", '4', glm::ivec2(10, 16), glm::ivec2(0, 0), true,
          "(There's an EECS 494 student working on her laptop nearby. "
          "She looks very busy and is doesn't want to talk.)",
          "()"),
    ...
    Actor("friend1", 'f', glm::ivec2(11, 8), glm::ivec2(0, 0), true,
          "H-hey (you spot a nearby friend in the darkness). Thank you "
          "for f-finding me. I'll sit here and rest a bit. [score up]",
          ""),
    Actor("friend2", 'f', glm::ivec2(13, 13), glm::ivec2(0, 0), true,
          "O-oh (you spot a nearby friend in the darkness). I'm glad "
          "I'm not a-alone... I'll sit here and r-rest a bit. Thanks. "
          "[score up]",
          ""),
    Actor(                    /* This player actor is always processed last, as it is the
                                 last actor in the actor list. */
          "player",           // actor name
          'p',                // view
